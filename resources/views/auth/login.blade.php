...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Log In | UnrealSoft. - Responsive Admin Dashboard Template</title>
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="index.html" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <!-- <img src="{{ asset('backend/assets/images/UnrealSoft.png') }} " alt="" height="55" width="88"> -->
                                            </span>
                                            <h2>UnrealSoft.</h2>
                                        </a>
...
<br>
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-3">
            ...
            <input class="form-control @error('login') is-invalid @enderror" name="login" type="text" id="login" required="" placeholder="Enter your Email/Name/Phone</label">
    @error('login')
